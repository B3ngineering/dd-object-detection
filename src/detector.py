...
class MultiModelDetector:
    ...
    def detect(self, frame):
        ...
        for idx, (model, weight, priority) in enumerate(zip(self.models, self.weights, self.priorities)):
...
class ObjectTracker:
    ...
    def _labels_compatible(self, label1, label2):
        ...
        vehicle_labels = {"car", "truck", "bus", "military_truck", "military_vehicle", "civilian_vehicle"}
